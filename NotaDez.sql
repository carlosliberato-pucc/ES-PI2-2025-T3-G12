...
CREATE TABLE nota_final (
    ...
    fk_turma     INT NOT NULL,
    CONSTRAINT fk_nf_aluno
      FOREIGN KEY (fk_id_aluno) REFERENCES alunos(id)
      ON DELETE CASCADE,
    CONSTRAINT fk_nf_turma
      FOREIGN KEY (fk_turma)    REFERENCES turmas(id_turma),
...
CREATE TABLE auditoria (
    ...
    CONSTRAINT fk_auditoria_usuario
      FOREIGN KEY (fk_usuario)  REFERENCES usuario(id_usuario),
    CONSTRAINT fk_auditoria_aluno
      FOREIGN KEY (fk_id_aluno) REFERENCES alunos(id)
      ON DELETE CASCADE,
    CONSTRAINT fk_auditoria_comp
      FOREIGN KEY (fk_compNota) REFERENCES componentes_notas(id_compNota)
      ON DELETE CASCADE
);
...
CREATE TABLE registra (
    ...
    CONSTRAINT fk_registra_comp
      FOREIGN KEY (fk_compNota)  REFERENCES componentes_notas(id_compNota),
    CONSTRAINT fk_registra_aud
