    ...
    try {
        ...
        db.query(
            ...
            (err, results) => {
                ...
                // Inserir curso
                db.query(
                    'INSERT INTO cursos (nome, periodo, fk_instituicao) VALUES (?, ?, ?)',
                    [nome, periodo || null, id_instituicao],
    ...
    try {
        ...
        db.query(
            ...
            (err, results) => {
                ...
                db.query(
                    'SELECT id_curso, nome, periodo FROM cursos WHERE fk_instituicao = ? ORDER BY nome',
                    [id_instituicao],
                    (cursosErr, cursos) => {
                        if (cursosErr) {
...
export const deletarCurso = async (req: Request, res: Response) => {
    try {
        ...
        db.query(
            `SELECT COUNT(*) as total FROM disciplinas WHERE fk_curso = ?`,
            [id_curso],
